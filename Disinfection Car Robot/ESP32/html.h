...
"      <label class='switch' style='margin-left: 10px;'>"
"        <input onclick='protected_mode_switch()' id='protected_mode_switch_id' type='checkbox'>"
"        <span class='slider round'></span>"
"      </label>"
"    </div>"
"  </div>"
...
"    function protected_mode_switch() {"
"      if (document.getElementById('protected_mode_switch_id').checked)"
"         protectedMode = true;"
"      else protectedMode = false;"
"    sendData('protectedmode');"
"    }"
